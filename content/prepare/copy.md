...
{% include docs/bootstrap/alert.md text="It's less important to get the naming exactly in the Google Sheet now, as you'll need to rename the spreadsheet later when you download it as a CSV file. But it's good practice to follow these conventions." %}
