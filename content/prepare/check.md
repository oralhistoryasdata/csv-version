...
{% include docs/figure.html img="/prep/transcript6.png" caption="Format > Text wrapping > Clip" alt="a screenshot of pasting text in google sheets" width="100%" %}

- Now you can see text that should be in the `words` column:

{% include docs/figure.html img="/prep/transcript7.png" caption="Rogue Text" alt="a screenshot of pasting text in google sheets" width="100%" %}
...
{% include docs/figure.html img="/prep/transcript8.png" caption="Transcript" alt="a screenshot of pasting text in google sheets" width="100%" %}
